...
function getAverage(value1, value2) {
  ...
  return ((value1 / min + value2 / min) / 2) * min;
}
// getAverage(10, 0);
/**
...
function roundToPowerOfTen(num, pow) {
  ...
  return Math.round(num / powers[pow], 0) * powers[pow];
}
...
function isPrime(n) {
  ...
  if (n > 4 && ((n ** 2) % 24 === 1)) isPrimeNumber = true;
  if (n === 119) isPrimeNumber = false;
